...
|{step:"deposit_amount";method:"binance"|"bep20"|"trc20"}|{step:"deposit_txid";amount:number;method:"binance"|"bep20"|"trc20"}|{step:"setting_value";key:string;back:"admin_payment"|"admin_settings"}|{step:"supplier_pick";productId:string};
