...
|{step:"help_title"}|{step:"help_content";id:string;title:string}|{step:"buy_qty";productId:string}|{step:"checkout";productId:string;quantity:number;total:number}
|{step:"admin_add"}|{step:"admin_remove"}|{step:"binance_uid"}|{step:"binance_name"}
|{step:"deposit_amount";method:"binance"|"bep20"|"trc20"}|{step:"deposit_txid";amount:number;method:"binance"|"bep20"|"trc20"}|{step:"setting_value";key:string;back:"admin_payment"|"admin_settings"}|{step:"supplier_pick";productId:string}|{step:"product_location";productId:string};
